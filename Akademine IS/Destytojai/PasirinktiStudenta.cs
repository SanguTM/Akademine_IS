...
namespace Akademine_IS
{
    public partial class PasirinktiStudenta : Form
    {
        ...
        int stddalykaiId;
        int dest;
        public PasirinktiStudenta(t_DataHandler DataHandler, int StudentoId, int StdDalykoId, int DestytojaiId)
        {
            std = StudentoId;
            dh = DataHandler;
            ...
            uspv_StudentuGrupesStudentai.ParamByName("@piPriskirtiDestytojus").Value = 0;
            uspv_StudentuGrupesStudentai.ParamByName("@piStudentaiId").Value = StudentoId;
